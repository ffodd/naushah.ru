...
<section class="bg-white">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <h2 class="max-w-2xl mb-4 text-4xl font-bold tracking-tight md:text-5xl xl:text-6xl">На ушах
                <span class="inline-block text-[#0980f3]">по Санкт-Петербургу</span>
            </h2>
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">Увлекательные маршруты, превосходный звук, а также первоклассные актеры, позволят вам погрузиться в новое измерение культуры и досуга.</p>
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img class="object-cover w-full h-56 rounded shadow-lg lg:rounded-none lg:shadow-none md:h-96 lg:h-full" src="{{ URL::asset('theme/img1.webp') }}" alt="На ушах по Санкт-Петербургу">
        </div>                
    </div>
</section>
<!-- finish section 1 -->
...
<section class="lg:mx-auto lg:container py-16 flex flex-row">
    <div class="glide pl-4 pr-4">
        ...
        <div class="inline-flex rounded-md shadow-sm" role="group">
            <button type="button" class="inline-flex items-center px-4 text-base font-medium text-gray-100 bg-blue-900 border border-gray-900 rounded-s-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
                <svg class="w-3 h-3 me-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button type="button" class="inline-flex items-center px-4 text-base font-medium text-gray-100 bg-cyan-900 border-t border-b border-gray-900 hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
                <svg class="w-3 h-3 me-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button type="button" class="inline-flex items-center px-4 text-base font-medium text-gray-100 bg-emerald-900 border border-gray-900 rounded-e-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white">
                <svg class="w-3 h-3 me-2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
