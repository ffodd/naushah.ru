...
<section class="text-gray-600 overflow-hidden">
  <div class="lg:container lg:mx-auto px-5 pt-8">
    <div class="xl:w-4/5 mx-auto flex">
      ...
      <div class="md:pl-10 lg:py-6 mt-6 md:mt-0">
        <div class="flex flex-row">
          ...
          <div class="ml-2 sm:ml-6 md:ml-0">
            <h2 class="uppercase text-xs sm:text-sm title-font text-gray-500 tracking-widest">{{$event->eventType->name}}</h2>
            <h1 class="text-gray-900 text-lg sm:text-2xl title-font font-medium mb-1">{{$event->name}}</h1>
            <div class="flex flex-col sm:flex-row mb-4">
              ...
              <span class="flex mt-2 sm:mt-0 sm:ml-3 sm:pl-3 py-2 border-t-2 sm:border-t-0 sm:border-l-2 border-gray-200 space-x-2s">
        ...
        <div class="text-xs sm:text-sm md:text-base mt-3">
          <p class="flex items-center">
            ...
            <span class="text-gray-800 font-semibold">Время:</span>
            <span class="text-gray-600 ml-1">{{$event->duration}}</span>
          </p>
          <p class="flex items-center mt-0.5 sm:mt-0">
            ...
            <span class="text-gray-800 font-semibold">Протяженность:</span>
            <span class="text-gray-600 ml-1"> {{$event->length}}</span>
          </p>
          <p class="flex items-center mt-0.5 sm:mt-0">
            <span class="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-800 rounded-full">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
            ...
            <span class="text-gray-800 font-semibold">Начало маршрута:</span>
            <span class="text-gray-600 ml-1"> {{$event->starting_point}}</span>
          </p>
          <p class="flex items-center mt-0.5 sm:mt-0">
            <span class="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-800 rounded-full">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
            ...
            <span class="text-gray-800 font-semibold">Конец маршрута:</span>
            <span class="text-gray-600 ml-1"> {{$event->finish_point}}</span>
          </p>
          <p class="flex items-center mt-0.5 sm:mt-0">
            <span class="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-800 rounded-full">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
            ...
            <span class="text-gray-800 font-semibold">Необходимо иметь:</span>
            <span class="text-gray-600 ml-1">наушники, телефон и интернет</span>
          </p>
          <p class="flex items-center mt-0.5 sm:mt-0">
            <span class="inline-flex items-center justify-center flex-shrink-0 w-4 h-4 mr-2 text-white bg-gray-800 rounded-full">
              <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" class="w-3 h-3" viewBox="0 0 24 24">
            ...
            <span class="text-gray-800 font-semibold">Экскурсия доступна</span>
            <span class="text-gray-600 ml-1">{{$event->availability_time}}</span>
          </p>
        </div>
...
<section class="lg:container lg:mx-auto">
  <div class="mb-4 border-b border-gray-2000">
      <ul class="flex flex-col sm:flex-row justify-center sm:justify-start -mb-px text-sm font-medium text-center" id="default-tab" data-tabs-toggle="#default-tab-content" role="tablist">
        <div class="flex flex-row justify-center">
          <li class="me-2" role="presentation">
              <button class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 group" id="profile-tab" data-tabs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                <svg class="w-5 h-5 me-2 text-gray-400 group-hover:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <li class="me-2" role="presentation">
              <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Политика отмены</button>
          </li>
        </div>
        <div class="flex flex-row justify-center">
          <li class="me-2" role="presentation">
              <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="settings-tab" data-tabs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">Отзывы 0</button>
          </li>
          <li role="presentation">
              <button class="inline-block p-4 border-b-2 rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="contacts-tab" data-tabs-target="#contacts" type="button" role="tab" aria-controls="contacts" aria-selected="false">Вопросы</button>
          </li>
        </div>
      </ul>
  </div>
  <div id="default-tab-content">
      ...
      <div class="hidden p-4 rounded-lg bg-gray-50" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
          <p class="text-sm text-gray-500">Раздел в <strong class="font-medium text-gray-800">разработе.</strong></p>
      </div>
